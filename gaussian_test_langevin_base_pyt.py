            ...
            for alpha in config.alpha_range:       
                for N in config.N_range:
                    ...
                    for i in iterator:
                        ...
                        adapt_d_t=config.adapt_d_t,adapt_d_t_mcmc=config.adapt_d_t_mcmc
                        ,d_t_decay=config.d_t_decay,d_t_gain=config.d_t_gain,track_d_t=config.track_d_t)
                        t1=time()-t
                        print(p_est)
