            ...
            for method,params in params_dic.items():
                ...
                for params_vals in product_params:
                    ...
                    same_exp_df = get_sel_df(df=aggr_res_df,cols=params_keys, vals=params_vals, 
                        ...
                        ('model_name',model_name,'=='),('input_index',config.input_index,'=='),
                        ('dataset',dataset,'==')])  
...
def main():
    ...
    if not os.path.exists(aggr_res_path):
        ...
        cols=['epsilon','method','dataset','N','model_name','input_index','rho','ratio','n_rep','T','alpha','min_rate','mean_time','std_time','mean_est','s',
