...
def ImportanceSplittingLpCert(gen,kernel,h,tau=0,N=100,s=0.1,decay=0.9,T = 20, accept_ratio = 0.9, 
...
alpha_est = 0.95,verbose=1, gain_thresh=0.01, check_every=3,n_max = int(10**4), 
  reject_forget_rate =0, gain_forget_rate=0, reject_thresh=0.005):
    """
      Importance splitting last particle estimator, i.e. the importance splitting algorithm with K=N-1
