...
from stat_reliability_measure.dev.imp_sampling.is_pyt import mpp_search, search_methods_list,hlrf, gaussian_space_attack, NormalToUnifLayer, binary_search_to_zero
...
def LineSampling(x_clean,gen,G,N:int=int(1e4),epsilon=None,y_clean=None,batch_size:int=int(1e3),save_rare:bool=False,verbose=0.,track_X:bool=False,
               ...
               model=None,search_method='mpp_search',u_mpp=None,stop_cond_type='beta',stop_eps=1e-3,save_mpp=False,
    ...
    if u_mpp is None:
        ...
        if search_method=='hlrf':
            ...
            u_mpp= gaussian_space_attack(x_clean=x_clean,y_clean=y_clean,model=model,noise_dist='uniform',
                        ...
                        attack = search_method,num_iter=num_iter,steps=steps, stepsize=stepsize, max_dist=None, epsilon=epsilon,
                            sigma=1., random_init=random_init , sigma_init=sigma_init,**kwargs)
