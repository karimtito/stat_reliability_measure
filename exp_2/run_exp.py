...
from dev.smc.smc_pyt import SMCSamplerConfig, smc_
from config import Exp2Config
from itertools import product as cartesian_product



method_config_dict={'amls':MLS_SMC_Config,'mala':SMCSamplerConfig,
                    'hmc':SMCSamplerConfig,'smc':SMCSamplerConfig,}
method_func_dict={'amls':amls_mls,''}

def run_stat_rel_exp(model, X, y, epsilon_range=[], noise_dist='uniform',dataset_name = 'dataset',
                 model_name='model',method = 'amls',
